...
<template>
  <div class="mx-3 mt-3">
    <h1 class="text-3xl md:text-5xl font-medium">Frequently Asked Questions</h1>
    ...
    <div class="my-5 md:my-10">
      ...
      <div>
        ...
        <Disclosure v-slot="{ open }">
          <DisclosureButton class="mt-3 flex w-full justify-between">
            <span class="w-64 md:w-full text-start text-2xl md:text-3xl font-semibold">How much do you charge?</span>
            <PlusIcon v-if="!open" class="mt-1 h-8 w-8 md:h-10 md:w-10" />
            <MinusIcon v-if="open" class="mt-1 h-8 w-8 md:h-10 md:w-10" />
          </DisclosureButton>
          <DisclosurePanel class="mt-2 md:text-lg py-3">
      ...
      <div>
        <Disclosure v-slot="{ open }">
          <DisclosureButton class="mt-3 flex w-full justify-between">
            <span class="w-64 md:w-full text-start text-2xl md:text-3xl font-semibold"
